...
#include "com_google_imageio_webp_WebP.h"
#include "com_google_imageio_webp_WebPReadParam.h"
#include "com_google_imageio_webp_WebPWriteParam.h"
...
JNIEXPORT jint JNICALL Java_com_google_imageio_webp_WebP_getInfo(
...
JNIEXPORT jintArray JNICALL Java_com_google_imageio_webp_WebP_decode(
  JNIEnv *env, jclass UNUSED(cls),
  jlong optionsPtr,
  jbyteArray data, jint offset, jint length, 
  jintArray outFlags, 
...
JNIEXPORT jtype JNICALL Java_com_google_imageio_webp_##cls##_##get##property \
  (JNIEnv* UNUSED(env), jclass UNUSED(cls_), jlong optionsPtr) { \
  type* options = (type*) (intptr_t) optionsPtr; \
  return options->field; \
} \
\
JNIEXPORT void JNICALL Java_com_google_imageio_webp_##cls##_##set##property \
  (JNIEnv* UNUSED(env), jclass UNUSED(cls_), jlong optionsPtr, jtype value) { \
  type* options = (type*) (intptr_t) optionsPtr; \
  options->field = value; \
}

JNIEXPORT jlong JNICALL Java_com_google_imageio_webp_WebPReadParam_createDecoderOptions
  (JNIEnv* UNUSED(env), jclass UNUSED(cls)) {
  WebPDecoderOptions* options = malloc(sizeof(WebPDecoderOptions));
  if (options) {
    memset(options, 0, sizeof(WebPDecoderOptions));
  }
  return (jlong)(intptr_t)options;
}

JNIEXPORT void JNICALL Java_com_google_imageio_webp_WebPReadParam_deleteDecoderOptions
  (JNIEnv* UNUSED(env), jclass UNUSED(cls_), jlong optionsPtr) {
...
JNIEXPORT jbyteArray JNICALL Java_com_google_imageio_webp_WebP_encodeRGBA
...
JNIEXPORT jbyteArray JNICALL Java_com_google_imageio_webp_WebP_encodeRGB
  (JNIEnv *env, jclass UNUSED(cls_), jlong configPtr, jbyteArray data, jint width, jint height, jint stride) {
  return encode(env, configPtr, WebPPictureImportRGB, data, width, height, stride);
}

JNIEXPORT jlong JNICALL Java_com_google_imageio_webp_WebPWriteParam_createConfig
  (JNIEnv* UNUSED(env), jclass UNUSED(cls_)) {
  WebPConfig* config = malloc(sizeof(WebPConfig));
  if (config) {
...
JNIEXPORT void JNICALL Java_com_google_imageio_webp_WebPWriteParam_deleteConfig
